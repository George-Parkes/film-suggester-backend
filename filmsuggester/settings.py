"""
Django settings for filmsuggester project.
...
SECRET_KEY = 'd-r94f+htr=n9w#l96naz9j^oukr^%lbz-&g$#p7b3sqt!+z9w'
...
ROOT_URLCONF = 'filmsuggester.urls'
...
WSGI_APPLICATION = 'filmsuggester.wsgi.application'
